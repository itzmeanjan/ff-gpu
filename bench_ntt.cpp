...
int64_t
benchmark_matrix_transposition(sycl::queue& q,
                               const uint64_t dim,
                               const uint64_t wg_size)
{
  uint64_t* vec_h =
    static_cast<uint64_t*>(sycl::malloc_host(sizeof(uint64_t) * dim * dim, q));
...
int64_t
benchmark_twiddle_factor_multiplication(sycl::queue& q,
                                        const uint64_t n1,
                                        const uint64_t n2,
                                        const uint64_t wg_size)
{
