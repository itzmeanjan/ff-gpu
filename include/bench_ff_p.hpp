...
void
gen_hilbert_matrix_ff_p(sycl::queue& q,
                        uint32_t* const mat,
                        const uint dim,
                        const uint wg_size);
...
void
benchmark_ff_p_addition(sycl::queue& q,
                        const uint32_t dim,
...
void
benchmark_ff_p_subtraction(sycl::queue& q,
                           const uint32_t dim,
                           const uint32_t wg_size,
                           const uint32_t itr_count);
...
void
benchmark_ff_p_multiplication(sycl::queue& q,
                              const uint32_t dim,
                              const uint32_t wg_size,
                              const uint32_t itr_count);
...
void
benchmark_ff_p_division(sycl::queue& q,
                        const uint32_t dim,
                        const uint32_t wg_size,
                        const uint32_t itr_count);
...
void
benchmark_ff_p_inversion(sycl::queue& q,
                         const uint32_t dim,
                         const uint32_t wg_size,
                         const uint32_t itr_count);
...
void
benchmark_ff_p_exponentiation(sycl::queue& q,
                              const uint32_t dim,
                              const uint32_t wg_size,
                              const uint32_t itr_count);
